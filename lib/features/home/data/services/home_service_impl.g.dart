...
part of 'home_service_impl.dart';
...
class _HomeServiceImpl implements HomeServiceImpl {
  ...
  @override
  Future<Categorys> getCategory() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Categorys>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'categories',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Categorys _value;
    try {
      _value = Categorys.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
